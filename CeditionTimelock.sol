...
contract CeditionTimelock {
    ...
    // minimul lock amount of token
    uint256 private _minLockAmount = 100000e18;
    ...
    constructor (IERC20 token_, address beneficiary_, uint256 releaseInterval_, uint256 releaseAmount_) {
        admin = msg.sender;
    ...
    /**
     * @notice Deposit tokens to timelock contract.
     */
